...
public interface IPaymentGatewayService
{
    ...
    Task<string> CreateCheckoutSessionAsync(string stripePriceId, string customerEmail, Guid customerId, Guid planId, string successUrl, string cancelUrl, CancellationToken cancellationToken);
    ...
    Task<string> CreateCustomerAsync(string email, CancellationToken cancellationToken);
}
